...
public class DataLoggerSource(List<Coordinates> coordinates)
{
    ...
    private (Pixel[] pointsBefore, int firstIndex) GetFirstPointX(IAxes axes)
    {
        ...
        var (firstPointPosition, firstPointIndex) = SearchIndex(axes.XAxis.Range.IsInverted ? axes.XAxis.Max : axes.XAxis.Min); // if axis is reversed first index will on the right limit of the plot
    ...
    private (Pixel[] pointsBefore, int firstIndex) GetFirstPointY(IAxes axes)
    {
        ...
        var (firstPointPosition, firstPointIndex) = SearchIndex(axes.YAxis.Range.IsInverted ? axes.YAxis.Max : axes.YAxis.Min); // if axis is reversed first index will on the top limit of the plot
    ...
    private (Pixel[] pointsAfter, int lastIndex) GetLastPointX(IAxes axes)
    {
        ...
        var (lastPointPosition, lastPointIndex) = SearchIndex(axes.XAxis.Range.IsInverted ? axes.XAxis.Min : axes.XAxis.Max); // if axis is reversed last index will on the left limit of the plot
    ...
    private (Pixel[] pointsAfter, int lastIndex) GetLastPointY(IAxes axes)
    {
        ...
        var (lastPointPosition, lastPointIndex) = SearchIndex(axes.YAxis.Range.IsInverted ? axes.YAxis.Min : axes.YAxis.Max); // if axis is reversed last index will on the bottom limit of the plot
